...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://admin:pass@cluster0.bqss1.mongodb.net/todo?retryWrites=true&w=majority")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/rajeshrakisI/ALPHA_MUSIC",
)
